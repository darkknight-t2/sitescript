...
function isSiteUrl( url ) {
    if ( url.match( /http:\/\/\w+\.sevenload\.com\/(shows|videos)\/.*/ ) ) {
        return true;
    }
}
...
function getVideoDetail( url ) {
    ...
    text.match( /<param name="flashVars" value="configPath=(.*?)"/ );
    ...
    text.match( /seeking="yes">(.*?)<\/location>/ );
