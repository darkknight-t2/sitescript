// ==SiteScript==
// @siteName    GuitarTube
// @siteUrl     http://www.guitar-tube.com/
// @author      DarkKnight
...
function isSiteUrl( url ) {
    if ( url.match( /http:\/\/www\.guitar-tube\.com\/watch\/.*\.html/ ) ) {
        return true;
    }
}
...
function getVideoDetail( url ) {
    ...
    text.match( /<a href=".*share_video\.php\?vkey=(.*?)"/ );
    var key = RegExp.$1;
    
    var xmlUrl = "http://www.guitar-tube.com/nvlab/econfig.php?key=" + key;
