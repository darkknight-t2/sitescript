...
function isSiteUrl( url ) {
    ...
    else if ( url.match( /http:\/\/wwwstatic\.megaporn\.com\/video\/mv_player\.swf\?image=.*&v=.*/ ) ) {
        return true;
    }
}
...
function getVideoDetail( url ) {
    ...
    var realUrl = "http://www" + server + ".megaporn.com/files/" + decrypt( un, key1, key2 ) + "/";
